...
const initialHud: Hud = { phase: "ready", time: 0, distance: 0, checkpoint: 0, coins: 0, deaths: 0, speed: RUN_SPEED, boost: false, height: 0, jumpLevel: 0, gamepad: false, input: "keyboard", paused: false, software: false };
...
export default function SpeedrunGame() {
  ...
  return <section className={`game-shell ${hud.boost ? "boosting" : ""}`}>
    ...
    <header className="hud">
      <div className="brand">NEON SPRINT <b>OSAKA</b><small>RIVER RUN — AUTO RUN v4</small></div>
